...
#[tauri::command]
#[specta::specta]
pub(crate) async fn get_current_ssid(
...
#[tauri::command]
#[specta::specta]
pub(crate) async fn get_trusted_ssids(app: AppHandle<tauri::Wry>) -> Result<Vec<String>, String> {
    crate::store::get_trusted_ssids(app).map_err(|e| e.to_string())
}

#[tauri::command]
#[specta::specta]
pub(crate) async fn add_trusted_ssid(
    ...
    crate::store::add_trusted_ssid(app, ssid)
        .await
    ...
    let status = state
        ...
        .map_err(|e| e.to_string())?;
    state
        .emit_location_event(LocationEventType::SettingsChanged, &status)
        .await;
...
#[tauri::command]
#[specta::specta]
pub(crate) async fn remove_trusted_ssid(
    app: AppHandle<tauri::Wry>,
    state: State<'_, LocationConnectivityState<tauri::Wry>>,
    ssid: String,
) -> Result<(), String> {
    ...
    crate::store::remove_trusted_ssid(app, ssid)
        .await
        .map_err(|e| e.to_string())?;
...
#[tauri::command]
#[specta::specta]
pub(crate) async fn is_location_based_enabled(app: AppHandle<tauri::Wry>) -> Result<bool, String> {
    crate::store::get_location_based_enabled(app).map_err(|e| e.to_string())
}

#[tauri::command]
#[specta::specta]
pub(crate) async fn set_location_based_enabled(
    app: AppHandle<tauri::Wry>,
    state: State<'_, LocationConnectivityState<tauri::Wry>>,
    enabled: bool,
) -> Result<(), String> {
...
#[tauri::command]
#[specta::specta]
pub(crate) async fn is_in_trusted_location(
    state: State<'_, LocationConnectivityState<tauri::Wry>>,
) -> Result<bool, String> {
    let status = state
        .get_location_status()
...
#[tauri::command]
#[specta::specta]
pub(crate) async fn get_location_status(
    state: State<'_, LocationConnectivityState<tauri::Wry>>,
